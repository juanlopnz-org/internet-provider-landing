      ...
      <div className="container-custom">
        <div className="max-w-3xl mx-auto text-center mb-16">
          ...
          <p className="text-xl text-gray-600">
            Estamos aquí para ayudarte. Comunícate con nosotros para resolver tus dudas o solicitar nuestros servicios
          </p>
        </div>
            ...
            <div>
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <div className="font-semibold text-dark mb-1">WhatsApp</div>
                    {contact.whatsapp.map((number, index) => (
                      <a
                        key={index}
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <div className="font-semibold text-dark mb-1">Correo Electrónico</div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <div className="font-semibold text-dark mb-1">Dirección</div>
            ...
            <div className="bg-gradient-to-br from-primary/5 to-accent/5 rounded-2xl p-6 border-l-4 border-primary">
              ...
              <div className="space-y-2 text-gray-700">
                ...
                <div className="flex justify-between">
                  ...
                  <span>{contact.schedule.weekend}</span>
                </div>
              </div>
            </div>
          ...
          <div className="card">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <p className="text-sm text-gray-500 text-center">
                Al enviar este formulario, serás redirigido a WhatsApp con tu mensaje preparado
              </p>
            </form>
          </div>
        </div>
